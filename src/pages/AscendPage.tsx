  ...
  <div className="pt-20 md:pt-24">
    ...
    <section className="relative min-h-[80vh] flex items-center">
      <div className="absolute inset-0">
        <img src={ascendHero} alt="Stealth Ascend" className="w-full h-full object-cover" width={1920} height={1080} />
        <div className="absolute inset-0 bg-gradient-to-r from-primary/90 via-primary/70 to-primary/40" />
      </div>
      <div className="relative container-wide section-padding py-32">
        <div className="max-w-xl">
          <span className="font-sans text-xs font-semibold uppercase tracking-[0.3em] text-accent mb-6 block">Stealth Ascend</span>
          <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl font-bold text-primary-foreground leading-[1.1] mb-6">
    ...
    <section className="py-20 md:py-28">
      <div className="container-narrow section-padding text-center">
        <span className="font-sans text-xs font-semibold uppercase tracking-[0.2em] text-accent mb-3 block">A Different Kind of Wellness</span>
    ...
    {/* Starter Kit */}
    <section id="starter-kit" className="py-20 md:py-28 bg-secondary">
      <div className="container-wide section-padding">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <span className="font-sans text-xs font-semibold uppercase tracking-[0.2em] text-accent mb-3 block">The Starter Kit</span>
            ...
            <h3 className="font-sans text-sm font-semibold uppercase tracking-wider mb-4">What's Included</h3>
            ...
            <p className="text-2xl font-sans font-semibold text-foreground mb-6">$129.00</p>
    ...
    <section className="py-20 md:py-28">
      <div className="container-narrow section-padding text-center">
        <span className="font-sans text-xs font-semibold uppercase tracking-[0.2em] text-accent mb-3 block">Sizing Guide</span>
        <h2 className="font-serif text-3xl md:text-4xl font-semibold text-foreground mb-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            ...
            <div key={s.size} className="p-6 rounded-lg bg-card border border-border">
              <h4 className="font-sans text-sm font-semibold mb-1">{s.size}</h4>
              <p className="text-2xl font-sans font-bold text-accent mb-1">{s.diameter}</p>
              <p className="text-xs text-muted-foreground">Best for: {s.best}</p>
            </div>
          ))}
        </div>
      </div>
    ...
    <section className="py-20 md:py-28 bg-secondary">
      <div className="container-narrow section-padding">
        <div className="text-center mb-12">
          ...
          <h2 className="font-serif text-3xl md:text-4xl font-semibold text-foreground mb-4">Safety & Responsibility</h2>
          <p className="text-muted-foreground text-lg leading-relaxed max-w-2xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            ...
            <div key={item.title} className="p-6 rounded-lg bg-card border border-border text-center">
              <h4 className="font-sans text-sm font-semibold mb-2">{item.title}</h4>
    ...
    <section className="py-20 md:py-28">
      <div className="container-narrow section-padding text-center">
        ...
        <h2 className="font-serif text-3xl md:text-4xl font-semibold text-foreground mb-4">Education First</h2>
    ...
    <section className="py-16 md:py-24 bg-secondary">
      <div className="container-wide section-padding text-center">
        <h2 className="font-serif text-2xl md:text-3xl font-semibold mb-10">Pair With Your Routine</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-2xl mx-auto">
          {[
            ...
            <div key={b.name} className="p-6 rounded-lg bg-card border border-border text-left">
              <span className="text-xs font-sans font-semibold text-accent">{b.save}</span>
              <h4 className="font-serif text-lg font-semibold mt-1 mb-2">{b.name}</h4>
